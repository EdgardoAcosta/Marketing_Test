...
<footer class="page-footer center-on-small-only">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-5 col-md-offset-1">
                ...
                adipisicing elit. Fugit, error amet numquam iure provident voluptate esse quasi,. </p>
    ...
    <div class="social-section">
        <ul>
            ...
            <li><a href="https://www.linkedin.com/in/dawid-adach-97435534/pl" target="_blank"
            ...
            <li><a href="https://www.instagram.com/mdbootstrap/" target="_blank" class="btn-floating btn-small btn-ins"><i
