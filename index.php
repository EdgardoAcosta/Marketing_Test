                        ...
                        <div class="col-lg-6">
                            <div class="description">
                                ...
                                <p class="wow fadeInLeft" data-wow-delay="0.4s">Dropbox Bussines Lorem ipsum dolor sit amet,
                                    consectetur adipiscing elit. Aenean at laoreet tellus. Curabitur posuere blandit massa. .</p>
                                <br>
        ...
        <div class="container">
            ...
            <section class="section" id="examples-of-use">
                ...
                <div class="row">
                    ...
                    <!--First column-->
                    <div class="col-md-12 m-b-r wow fadeInDown">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('http://mdbootstrap.com/images/regular/dark/img%20(2).jpg')">
                    ...
                    <!--Second column-->
                    <div class="col-md-6 m-b-r wow fadeInUp" data-wow-delay="0.2s">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('http://mdbootstrap.com/images/regular/dark/img%20(7).jpg')">
                    ...
                    <!--Third column-->
                    <div class="col-md-6 m-b-r wow fadeInUp" data-wow-delay="0.4s">
                        <!--Card-->
                        <div class="card-overlay" style="background-image: url('http://mdbootstrap.com/images/regular/dark/img%20(8).jpg')">
                            ...
                            <div class="carousel-item active">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(1).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Anna Deynah</h4>
                                        <h5>Web Designer</h5>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(3).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>John Doe</h4>
                                        <h5>Web Developer</h5>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(5).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Abbey Clark</h4>
                                        <h5>Photographer</h5>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(4).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Blake Dabney</h4>
                                        <h5>Web Designer</h5>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(6).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Andrea Clay</h4>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(7).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Cami Gosse</h4>
                                        <h5>Phtographer</h5>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(8).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Bobby Haley</h4>
                                        <h5>Web Developer</h5>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(10).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Elisa Janson</h4>
                                        <h5>Marketer</h5>
                                ...
                                <div class="col-md-4 hidden-sm-down">
                                    <div class="testimonial">
                                        <!--Avatar-->
                                        <div class="avatar">
                                            <img src="http://mdbootstrap.com/images/avatars/img%20(9).jpg" class="img-circle img-fluid">
                                        </div>
                                        <!--Content-->
                                        <h4>Robert Jacobs</h4>
                                        <h5>Front-end developer</h5>
            ...
            <section class="section" id="pricing">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 m-b-r wow fadeIn" data-wow-delay="0.2s">
                        <!--Card-->
                        <div class="card-overlay pricing-card" style="background-image: url('http://mdbootstrap.com/images/regular/dark/img%20(8).jpg')">
                            ...
                            <div class="white-text text-xs-center">
                                <div class="card-block">
                                    ...
                                    <a class="btn btn-lg btn-white-outline"> Buy now</a>
                                </div>
                            </div>
                        ...
                        <div class="card-wrapper">
                            <div id="card-1" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!--Avatar-->
                                    <div class="avatar"><img src="http://mdbootstrap.com/images/avatars/img%20(2).jpg" class="img-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Maria Kate</h4>
                        ...
                        <div class="card-wrapper">
                            <div id="card-2" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!--Avatar-->
                                    <div class="avatar"><img src="http://mdbootstrap.com/images/avatars/img%20(1).jpg" class="img-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Anna Deynah</h4>
                        ...
                        <div class="card-wrapper">
                            <div id="card-3" class="card-rotating effect__click">
                                ...
                                <div class="face front">
                                    ...
                                    <!--Avatar-->
                                    <div class="avatar"><img src="http://mdbootstrap.com/images/avatars/img%20(5).jpg" class="img-circle img-responsive">
                                    </div>
                                    <!--Content-->
                                    <div class="card-block">
                                        <h4>Sarah Melyah</h4>
